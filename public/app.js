        ...
        */
        ...
        function switchLibraryPane(cat) {
            ...
            if (label) {
                ...
                const name = ({decks:'DECKS', trainees:'TRAINEES', parents:'PARENTS', session:'SESSION PARENTS', borrow:'BORROW', 'card-borrow':'CARD BORROW', friends:'FRIENDS', cards:'OWNED CARDS', bot:'BOT VIEW', test:'TEST 92'})[cat] || cat.toUpperCase();
                const n = counts[cat];
        ...
        function updateRailCounts() {
            ...
            if (label && counts[retuned.currentPane] != null) {
                const name = ({decks:'DECKS', trainees:'TRAINEES', parents:'PARENTS', session:'SESSION PARENTS', borrow:'BORROW', 'card-borrow':'CARD BORROW', friends:'FRIENDS', cards:'OWNED CARDS', bot:'BOT VIEW', test:'TEST 92'})[retuned.currentPane] || retuned.currentPane.toUpperCase();
