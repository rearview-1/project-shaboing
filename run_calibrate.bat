@echo off
REM Fast deck calibration — runs a 3-5 minute sim sweep against your
...
REM   2. Runs a baseline (4 sims) to see where the deck currently lands
...
REM   7. Saves the winner to uma_runtime/instances/account_b/sim_observations/deck_policies.json
REM
REM After this finishes, just click RUN CAREER in the UI as normal.
REM
REM Comfort gate (all four must hold):
REM   - SS rate     >= TARGET_SS_RATE       (default 0.80)
...
REM   SWEEPY_CALIBRATE_TIME_BUDGET_SEC   default 240 (4 minutes)
REM   SWEEPY_CALIBRATE_TARGET_SS_RATE    default 0.80
