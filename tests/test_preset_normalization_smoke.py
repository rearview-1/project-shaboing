...
class PresetNormalizationSmokeTests(unittest.TestCase):
    ...
    def test_auto_learning_recency_defaults_are_present(self):
        ...
        self.assertEqual(preset["calendar_race_clean_prebuy_budget"], 1400)
        self.assertEqual(preset["calendar_race_clean_prebuy_keep_sp"], 0)
        self.assertEqual(preset["calendar_race_clean_prebuy_max_skills"], 10)
        self.assertEqual(preset["calendar_race_clean_prebuy_target_probability"], 0.985)
        self.assertIs(preset["g1_race_continue_enabled"], True)
        self.assertEqual(preset["g1_race_continue_min_limit"], 5)
