...
class PublicAppStaticTests(unittest.TestCase):
    ...
    def test_library_test_tab_exists(self):
        ...
        self.assertIn('<span class="rail-name">Test 92</span>', index_html)
        self.assertIn('data-pane="test"', index_html)
        self.assertIn("Test 92 tab is wired and selectable.", index_html)
        self.assertIn("test:'TEST 92'", app_js)
